...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement> & { border?: boolean }>(({ className, border = true, ...props }, ref) => <div ref={ref} className={cn("rounded-lg bg-card text-card-foreground shadow-sm", border && "border", className)} {...props} />);
