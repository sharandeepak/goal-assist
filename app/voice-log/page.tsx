	...
	>([
		{
			...
			content: "Completed the authentication flow and fixed responsive design issues. Blocked by waiting for API documentation from the backend team. Planning to complete unit tests and start work on the dashboard UI tomorrow.",
			type: "standup",
		},
		{
			id: 2,
			date: new Date(Date.now() - 86400000).toISOString(), // Yesterday
			content: "Created component library and set up CI/CD pipeline. No blockers today. Planning to implement authentication flow tomorrow.",
			type: "standup",
		},
	]);
					...
					{transcript && (
						<div className="space-y-4">
							<div>
								...
								<Textarea value={editedTranscript} onChange={(e) => setEditedTranscript(e.target.value)} className="min-h-[150px]" placeholder="Edit your transcript here..." />
							</div>
